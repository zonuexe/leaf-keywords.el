...
** :borg keyword
~:borg~ keyword provide frontend for [[https://github.com/emacscollective/borg][borg]].

To load the not assimilated clone package in borg must be enabled with =borg-activate=.
